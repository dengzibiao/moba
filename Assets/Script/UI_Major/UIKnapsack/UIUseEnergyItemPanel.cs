...
public class UIUseEnergyItemPanel : GUIBase
{
    ...
    private object item;
    ItemData equipItem;
    public static UIUseEnergyItemPanel instance;
    int currentCount = 1;
    int maxCount = 0;
    public GameObject backObj;
    public override UIPanleID GetUIKey()
    {
        return UIPanleID.UIUseEnergyItemPanel;
    }
    ...
    protected override void ShowHandler()
    {
        ...
        if (GameLibrary.Instance().ItemStateList.ContainsKey(equipItem.Id))
        {
            ...
            unitExpValue.text = itemnodestate.power_add.ToString();
            totalExpValue.text = currentCount * itemnodestate.power_add + "";
        }
