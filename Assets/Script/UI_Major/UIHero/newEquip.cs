...
{
    public GameObject strenthBtn;//强化按钮
    ...
    //    else
    //    {
    //        PromptPanel.instance.ShowPrompt("装备未满足进阶需求");
    //    }
    ...
    //    {
    //        print("金币不足，弹出点金手");
    //        Control.ShowGUI(GameLibrary.UIGoldHand);
    //        return;
    //    }
    ...
    //        }
    //    }
    //    //HeroPreview.Instance().RefreshUI(hd);
    //}
    ...
    //    Control.ShowGUI(GameLibrary.UIEquipInfoPanel);
