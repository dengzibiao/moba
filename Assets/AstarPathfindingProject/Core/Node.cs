...
#if ASTAR_NoHeuristic || ASTAR_ManhattanHeuristic || ASTAR_DiagonalManhattanHeuristic || ASTAR_EucledianHeuristic
	#define DefinedHeuristic
#endif
...
#if ASTAR_ConfigureTagsAsMultiple
		public int tags = 1;
#else
