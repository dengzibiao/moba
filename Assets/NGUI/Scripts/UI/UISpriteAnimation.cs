...
public class UISpriteAnimation : MonoBehaviour
{
    ...
    [HideInInspector][SerializeField] protected string mStartName = "";
    ...
    /// </summary>
    public string mmstartName { get { return mStartName; } set { if (mStartName != value) { mStartName = value; RebuildSpriteList(); } } }
