...
public abstract class UIRect : MonoBehaviour
{
	...
	public void Update ()
	{
		...
		if (Application.isPlaying && frame % GameLibrary.mTowerDelay != 0 && StartLandingShuJu.GetInstance()!=null&&StartLandingShuJu.GetInstance().currentScene == GameLibrary.PVP_Moba3v3) return;
